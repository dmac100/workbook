...
public class StyledTextCompletionTest {
	public static class FakeStyledText {
		StringBuilder text;
		int caretOffset;
		...
		public void replaceTextRange(int start, int length, String s) {
	...
	private static StyledText fakeStyledText(final String textWithCaret) {
		...
		return Mockito.mock(StyledText.class, AdditionalAnswers.delegatesTo(new FakeStyledText(text, caret)));
	}
